...
noseContour = (bwboundaries(imageNoseEdge,8));
noseContoura = noseContour{:};
noseContour1 = noseContoura(1:sum(imageNoseEdge(:)));
%chainCode = chaincode([noseContour1(end:-1:1,1) noseContour1(end:-1:1,2)],'true');
chainCode = chaincode([noseContour1(:,1) noseContour1(:,2)],'true');
sigma = 5;
