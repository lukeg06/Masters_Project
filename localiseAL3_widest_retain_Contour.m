% Slightly different from the other methods as this technique actually keeps the contour regardless of whether it is within the defined search region of not.
function [ALLocation] = localiseAL3_widest_retain_Contour(imageIn,PRNLocation,sigma,displayImage)
...
% Label edges
image_labelled = bwlabeln(imageEdge,8);
