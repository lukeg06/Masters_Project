...
function [output] = localiseEXLeft(imageIn,imageIn2D,EN_LeftCoordinates,EN_RightCoordinates,method)
...
ex_left_estimate = [(EN_LeftCoordinates(1) - norm(EN_LeftCoordinates(1) - EN_RightCoordinates(1))),...
   ...
   ex_left_estimate = [1,(EN_LeftCoordinates(2) + EN_RightCoordinates(2))/2];
