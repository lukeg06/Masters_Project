...
test_localiseEN_Left_sigmaResultsFileID = fopen('C:\Documents and Settings\Luke\My Documents\Masters_Project\Results\test_localiseEN_Left_sigmaResults.txt','w');
fprintf(test_localiseEN_Left_sigmaResultsFileID,'No.\tX Std(mm)\tY Std(mm)\tRad Std(mm)\n');
...
for sigma = 1:30
    ...
    for i = 1:200
        ...
        x_error(i) = abs(maxLocation(1) - landmarkLocations(5,1,ind_Img));
        y_error(i) = abs(maxLocation(2) - landmarkLocations(5,2,ind_Img));
    ...
    fprintf(test_localiseEN_Left_sigmaResultsFileID,'%d\t%f\t%f\t%f\t%f\t%f\t%f\n',sigma,results);
    fprintf('%d\t%f\t%f\t%f\t%f\t%f\t%f\n',sigma,results)
    
end

fclose(test_localiseEN_Left_sigmaResultsFileID);

copyfile('C:\Documents and Settings\Luke\My Documents\Masters_Project\Results\test_localiseEN_Left_sigmaResults.txt','C:\Documents and Settings\Luke\My Documents\Dropbox\Project results\test_localiseEN_Left_sigmaResults.txt')
