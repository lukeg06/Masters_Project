...
imageMasked((estimatedLocation_pixels(2) - mm2pixel(48)):(estimatedLocation_pixels(2) + mm2pixel(48)),(estimatedLocation_pixels(1) - mm2pixel(48)):(estimatedLocation_pixels(1) + mm2pixel(48))) = K((estimatedLocation_pixels(2) - mm2pixel(48)):(estimatedLocation_pixels(2) + mm2pixel(48)),(estimatedLocation_pixels(1) - mm2pixel(48)):(estimatedLocation_pixels(1) + mm2pixel(48)));
