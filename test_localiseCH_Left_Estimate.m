...
y_error = abs(maxLocation(1) - landmarkLocations(15,1,ind_Img));
x_error = abs(maxLocation(2) - landmarkLocations(15,2,ind_Img));
euclidean_error = norm(maxLocation - landmarkLocations(15,:,ind_Img));
