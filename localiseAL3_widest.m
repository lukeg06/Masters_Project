...
imageMasked((prn_coordinates(2) -mm2pixel(windowSize(2))):(prn_coordinates(2) +mm2pixel(windowSize(2))),...
    (prn_coordinates(1) -mm2pixel(windowSize(1))):(prn_coordinates(1) +mm2pixel(windowSize(1)))) ...
    = imageEdge((prn_coordinates(2) -mm2pixel(windowSize(2))):(prn_coordinates(2) +mm2pixel(windowSize(2))),...
    (prn_coordinates(1) -mm2pixel(windowSize(1))):(prn_coordinates(1) +mm2pixel(windowSize(1))));
